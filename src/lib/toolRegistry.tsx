...
export const TOOL_REGISTRY: ToolRegistryItem[] = [
  ...
  { id: 'chat', name: '模型对话', description: '支持多会话与流式输出的模型对话工具。', keywords: ['对话', 'chat', 'ai'], category: 'dev', icon: Bot, path: '/tool/chat', component: lazyNamed(() => import('../tools/ModelChatTool'), 'ModelChatTool') },
